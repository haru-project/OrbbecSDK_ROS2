...
def generate_launch_description():
    ...
    tf_args = [
        ...
        DeclareLaunchArgument("azure_pos_x", default_value="0.0"),
        DeclareLaunchArgument("azure_pos_y", default_value="0.0"),
        DeclareLaunchArgument("azure_pos_z", default_value="1.0"),
        DeclareLaunchArgument("azure_roll", default_value="0.0"),
        DeclareLaunchArgument("azure_pitch", default_value="0.0"),
        DeclareLaunchArgument("azure_yaw", default_value="-1.5"),
        # Azure to strawberry/camera transform parameters
        DeclareLaunchArgument("pos_x", default_value="0.0"),
        DeclareLaunchArgument("pos_y", default_value="0.0"),
        DeclareLaunchArgument("pos_z", default_value="0.0"),
        ...
        # strawberry/camera to camera_link transform parameters
    ...
    tf_nodes = [
        Node(
            ...
            arguments=[
                ...
                LaunchConfiguration("azure_pos_z"),
                LaunchConfiguration("azure_roll"),
                LaunchConfiguration("azure_pitch"),
                LaunchConfiguration("azure_yaw"),
